...
export const Orderbook = () => {
  ...
  useEffect(() => {
    ...
    const fetchInitialOrderbook = async () => {
      ...
      try {
        ...
        const depth = await api.getDepth(lbankSymbol, APP_CONFIG.DEFAULT_ORDERBOOK_SIZE)
        ...
        logger.error('Error fetching orderbook', error as Error)
  ...
  const itemsToShow = viewMode === 'both' ? APP_CONFIG.ORDERBOOK_DISPLAY_ITEMS_BOTH : APP_CONFIG.ORDERBOOK_DISPLAY_ITEMS_SINGLE
