  ...
  useEffect(() => {
    ...
    const fetchInitialTicker = async () => {
      try {
        ...
        logger.error('Error fetching initial ticker', error as Error)
      }
    }
    ...
    <>
      <div className="flex items-center justify-between bg-background border-b border px-2 md:px-4 py-2 overflow-x-auto">
        <div className="flex items-center gap-3 md:gap-6 lg:gap-8">
          ...
          <div className="flex flex-col min-w-fit min-w-[80px] md:min-w-[150px]">
            <span className={`text-sm md:text-xl lg:text-2xl font-bold ${isPriceUp ? 'text-trading-green' : 'text-trading-red'}`}>
